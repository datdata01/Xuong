    ...
    <div class="banner-top banner-top-2 row">
        <div class="col-md-3 col-sm-6">
            <a href="#" class="banner-top-2-child" style="background-color: #5BAB7B;">
                <div class="text-white">Vaxin</div>
            </a>
        </div>

        <div class="col-md-3 col-sm-6">
            <a href="#" class="banner-top-2-child" style="background-color: #5C9CCA;">
                <div class="text-white" style="margin: 0 auto;">Phòng chăm sóc đặc biệt</div>
            </a>
        </div>

        <div class="col-md-3 col-sm-6">
            <a href="#" class="banner-top-2-child" style="background-color: #C67B36;">
                <div class="text-white" style="margin: 0 auto;">Man Grooming spa dành cho người bệnh</div>
            </a>
        </div>
...
<div class="body">
    ...
    <div class="body__mainTitle d-flex align-items-center">
        <h2>Sản phẩm dành cho người đề kháng yếu</h2>
        <b>
            <div class="d-flex justify-content-center align-items-center ml-5" style="font-size: 26px;">
                <div id="fordog" class="text-secondary activeColor mr-3">vaxin</div>
...
<div class="body">
    ...
    <div class="body__mainTitle d-flex align-items-center">
        <h2>Sản phẩm dành cho bệnh nhân HIV</h2>
        <b>
            <div class="d-flex justify-content-center align-items-center ml-5" style="font-size: 26px;">
                <div id="forcat" class="text-secondary activeColor mr-3">Vaxin</div>
...
<div class="body">
    ...
    <div class="body__mainTitle d-flex align-items-center">
        ...
        <b>
            <div class="d-flex justify-content-center align-items-center ml-5" style="font-size: 26px;">
                <div id="clickDog" class="text-secondary activeColor mr-3">Vaxin olerol thế hệ 4</div>
                <div id="clickCat" class="text-secondary mr-3">Huyết thanh HIV</div>
            </div>
        </b>
