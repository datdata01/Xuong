    ...
    <style>
        /* Thay đổi màu nền toàn bộ trang */
            body {
                ...
                color: #343a40; /* Màu chữ tối cho dễ đọc */
            }

            /* Thay đổi màu nền và màu chữ của tiêu đề */
            .header {
                background-color: #e9ecef; /* Màu nền sáng cho header */
            }

            .navbar {
                background-color: #ffffff; /* Nền trắng cho thanh điều hướng */
            }
            ...
            .navbar__menu ul li a {
                color: #007bff; /* Màu xanh dương nhạt cho liên kết */
            }

            .navbar__search input {
                border: 1px solid #ced4da; /* Viền nhẹ cho ô tìm kiếm */
            }

            .navbar__shoppingCart img {
                filter: invert(50%); /* Đổi màu icon giỏ hàng */
            }

            /* Thay đổi màu sắc của footer */
            .footer {
                background-color: #e9ecef; /* Màu nền sáng cho footer */
                color: #343a40; /* Màu chữ tối cho footer */
            }

            .footer__social a {
                color: #007bff; /* Màu xanh dương cho các biểu tượng xã hội */
            }

            /* Thay đổi màu sắc của nút và các phần tử tương tác */
            button {
                background-color: #007bff; /* Màu xanh dương cho nút */
                color: #ffffff; /* Màu chữ trắng cho nút */
            }

            /* Thay đổi màu chữ trong footer */
            .footer__info-content h3 {
                color: #007bff; /* Màu xanh dương cho tiêu đề trong footer */
            }
            ...
            <div class="navbar__left">
                ...
                <div class="navbar__menu">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ URL::to('/congiong')}}">Đặc biệt</a></li>
                        <li>
    ...
    <footer>
        ...
        <div class="footer__info">
            ...
            <div class="footer__info-content">
                <h3>Giới thiệu</h3>
                <p>Website y tế, sản phẩm, dịch vụ cho người bênh</p>
            </div>
            ...
            <div class="footer__info-content">
                <h3>Liên hệ</h3>
                <p>Địa chỉ: Ha vy, le loi, thuong tin , ha noi</p>
                <p>Email: datdata01@gmail.com</p>
                <p>Sđt: 0959235823</p>
            </div>
        ...
        <div class="footer__copyright">
            <center> 2024 in the word</center>
        </div>
    </footer>
